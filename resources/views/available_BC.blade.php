                  ...
                  @if ($value->id_kapal == $pakai1[1])
                    <div class="disabled" style="background-color:#f1f1f1; padding: 10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-10">
                          <p><b>Fast Boat : </b>{{$value->nama_kapal}}</p>
                          @if (($value->kapasitas - $pakai1[0]) - $total_penumpang < 0)
                          ...
                          @else
                            <p><b>Available Capacity : </b>{{$value->kapasitas - $pakai1[0]}}</p>
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                  ...
                  @if ($value->id_kapal == $pakai2[1])
                    ...
                    <div class="disabled" style="background-color:#f1f1f1; padding: 10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-10">
                          <p><b>Fast Boat : </b>{{$value->nama_kapal}}</p>
                          @if (($value->kapasitas - $pakai2[0]) - $total_penumpang < 0)
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                            <div class="alert alert-danger">Sorry, seat is full.</div>
                          @else
                            <p><b>Available Capacity : </b>{{$value->kapasitas - $pakai2[0]}}</p>
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                  ...
                  @if ($value->id_kapal == $pakai3[1])
                    ...
                    <div class="disabled" style="background-color:#f1f1f1; padding: 10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-10">
                          <p><b>Fast Boat : </b>{{$value->nama_kapal}}</p>
                          @if (($value->kapasitas - $pakai3[0]) - $total_penumpang < 0)
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                            <div class="alert alert-danger">Sorry, seat is full.</div>
                          @else
                            <p><b>Available Capacity : </b>{{$value->kapasitas - $pakai3[0]}}</p>
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                  ...
                  @if ($value->id_kapal == $pakai4[1])
                    ...
                    <div class="disabled" style="background-color:#f1f1f1; padding: 10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-10">
                          <p><b>Fast Boat : </b>{{$value->nama_kapal}}</p>
                          @if (($value->kapasitas - $pakai4[0]) - $total_penumpang < 0)
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
                            <div class="alert alert-danger">Sorry, seat is full.</div>
                          @else
                            <p><b>Available Capacity : </b>{{$value->kapasitas - $pakai4[0]}}</p>
                            <p><b>Departure Time : </b>{{date("H:i", strtotime($perjalanan->jam))}}</p>
                            <p><b>Estimated Arrived Time : </b>{{date("H:i", strtotime($perjalanan->jam) + (int)$perjalanan->durasi)}}</p>
                            <p><b>Price : </b>IDR {{ number_format($perjalanan->harga_dewasa, 2, ',', '.')}}</p>
